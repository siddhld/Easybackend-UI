...
const SocialLinks = () => {
  return (
    <>
      <div className="absolute head">
        <div className="social-links">
          <div id="twitter" className="social-btn flex-center">
            <a
              target="_blank"
              href="https://x.com/Siddharthhld?t=NFevlNJWXDrQYMycPebV2A&s=09"
            >
              <svg
                viewBox="0 0 24 24"
                height="24"
          ...
          <div id="github" className="social-btn flex-center">
            <a target="_blank" href="https://github.com/siddhld">
              <svg
                viewBox="0 0 24 24"
                height="24"
                width="24"
      ...
      {/* Disabling Docs for Mobile view */}
      <style jsx>{`
